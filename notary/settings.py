"""
Django settings for notary project.
...
SECRET_KEY = 'django-insecure-w0_slq#y+pdk!@73()ezu--xmqbl5@#*2ojln08j@x1u!-6dyt'
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'noreply@sahal.com')
