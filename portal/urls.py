...
urlpatterns = [
    ...
    path('notary/create/', role_required(User.Role.NOTARY)(CreateDocumentWizard.as_view()), name='notary_create'),
    path('notary/create/success/<str:ref>/', views_notary.create_success, name='notary_create_success'),
    path('notary/documents/', views_notary.my_documents, name='notary_documents'),
